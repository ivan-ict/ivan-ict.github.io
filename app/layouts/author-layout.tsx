...
export function AuthorLayout({ children, content }: Props) {
  return (
    <Container className="pt-4 lg:pt-12">
      <PageHeader
        title="About"
        description="A bit of background on who I am, what I do, and why I started this blog."
        ...
        <div className="md:col-span-2 md:pl-12 xl:pl-16">
          <div className="prose prose-lg dark:prose-invert">
            <div>
              ...
              <p>
                I'm <strong>Tien Hoang </strong> (alias <strong>Ivan</strong> at
                work), a software engineer from <strong>Vietnam</strong>. I have
                a passion for all things <strong>Javascript</strong>. I enjoy
            ...
            <div>
              <div className="mb-[1em] mt-[2em] flex items-center justify-between">
                <h2>My career</h2>
              ...
              <div>
                ...
                <ul>
                  <li>
                    ...
                    Page router:{" "}
                    <a
                      href="https://ivan-ict.github.io/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      https://ivan-ict.github.io/
                    </a>
                  </li>
                  <li>
