  ...
  return (
    <Component
      className={clsx([
        ...
        "transition-[background-size] duration-[var(--duration,300ms)] ease-linear",
        "from-green-200/100 to-green-100/100",
        "dark:from-emerald-800/100 dark:to-emerald-900/100",
        active
